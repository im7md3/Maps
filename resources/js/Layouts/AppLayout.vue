                    ...
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div class="flex justify-between items-center h-16">
                            <div class="flex">
                                ...
                                <div class="hidden space-x-8 sm:-my-px sm:mx-10 sm:flex ">
                                    <jet-nav-link v-show="$page.props.user.role_id==1" :class="text-white" :href="route('places.create')"
                            ...
                            <div class="hidden sm:flex sm:items-center sm:ml-6">
                                ...
                                <jet-responsive-nav-link v-show="$page.props.user.role_id==1" :href="route('places.create')"
                                    :active="route().current('places')"
                                    >
                                    {{__('Add Place')}}
                                </jet-responsive-nav-link>
                                <jet-responsive-nav-link :href="route('bookmark.index')"
                            ...
                            <div class="flex items-center px-4">
                                <div v-if="$page.props.jetstream.managesProfilePhotos" class="flex-shrink-0 mr-3">
                                    <img class="h-10 w-10 rounded-full object-cover"
                                        :src="$page.props.asset +$page.props.user.profile_photo_path" :alt="$page.props.user.name" />
                                </div>
...
<script>
    ...
    import Serach from '@/Shared/search'
